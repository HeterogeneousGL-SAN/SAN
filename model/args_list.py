...
def get_args():
	...
	# sampling params
	parser.add_argument('-max_walk_length',default=10,type=int,help='The maximum number of nodes in a single path')
	parser.add_argument('-num_random_walks',default=40,type=float,help='number of walks sampled per node')
	...
	# sampling params
	parser.add_argument('-all_aggregation',default='concat',type=str,choices=['mean','concat','lstm','mh-attention'],help='all nodes aggregation')
	parser.add_argument('-core_aggregation',default='mh-attention',choices=['lstm','attention','mean_pooling','mh-attention'],type=str,help='core based nodes aggregation')
	parser.add_argument('-key_aggregation',default='mh-attention',type=str,choices=['lstm','attention','mh-attention'],help='keyword based nodes aggregation')
	parser.add_argument('-top_aggregation',default='mh-attention',type=str,choices=['lstm','attention','mh-attention'],help='topology based nodes aggregation')
